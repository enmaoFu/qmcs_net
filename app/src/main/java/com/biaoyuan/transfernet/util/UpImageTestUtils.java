package com.biaoyuan.transfernet.util;
...
import com.biaoyuan.transfernet.app.MyApplication;
import com.biaoyuan.transfernet.config.UserManger;
import com.biaoyuan.transfernet.domain.AliyunSTS;
...
public class UpImageTestUtils {
     ...
     */
    public UpImageTestUtils(BaseFrameAty aty, String tag, final UpImageListener mListener) {
    ...
    private void startUpImage() {
        ...
        String objectKey = mAliyunSTS.getSaveDirectory() + "/" + filesPath.get(number).getId() + "/" + file.getName();
                ...
                try {
                    ...
                    if (object.containsKey("code")) {
                        ...
                        if (code == 200) {
                            ...
                            pathRoot = mAliyunSTS.getSaveDirectory();
                            ...
                            if (code == 401) {
                                ...
                                mBaseFrameAty.dismissLoadingDialog();
    ...
    public void deleteFile() {
        ...
        for (PicInfo picInfo : filesPath) {
            ...
            File file = new File(path);
            String objectKey = mAliyunSTS.getSaveDirectory() + "/" + picInfo.getId() + "/" + file.getName();
