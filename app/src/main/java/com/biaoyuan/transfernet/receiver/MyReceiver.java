package com.biaoyuan.transfernet.receiver;
...
import com.biaoyuan.transfernet.ui.send.SendMessageActivity;
	...
	public void onReceive(Context context, Intent intent) {
		try {
			...
			if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
				 ...
				 * 在SendMessageActivity里可以不对值进行获取
				 */
