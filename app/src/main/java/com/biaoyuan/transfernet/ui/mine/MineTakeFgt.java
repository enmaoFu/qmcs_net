...
import com.biaoyuan.transfernet.adapter.MineTakeWaitAdapter;
    ...
    public void initData() {
        ...
        mPtrFrame.setPtrHandler(new PtrDefaultHandler() {
            ...
            public void onRefreshBegin(PtrFrameLayout frame) {
                //刷新页码归一，重新开启下拉加载
                targetPage = 1;
                doHttp(RetrofitUtils.createApi(Mine.class).getMyPickUp(Integer.parseInt(UserManger.pageSize),targetPage,2),1);
            }
        });
        ...
        //实例化适配器
        mAdapter = new MineTakeWaitAdapter(R.layout.item_mine_wait_take,new ArrayList<MineTakeWaitInfo>());
        //设置布局管理器
            ...
            public void onLoadMoreRequested() {
                ...
                mRecyclerView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        doHttp(RetrofitUtils.createApi(Mine.class).getMyPickUp(Integer.parseInt(UserManger.pageSize),targetPage,2),2);
                    }
                });
    ...
    public void onSuccess(String result, Call<ResponseBody> call, Response<ResponseBody> response, int what) {
        ...
        switch (what){
            case 1:
                ...
                mAdapter.removeAll();
                List<MineTakeWaitInfo> mineTakeWaitInfos = AppJsonUtil.getArrayList(result,MineTakeWaitInfo.class);
                if (mineTakeWaitInfos != null) {
                    mAdapter.setNewData(mineTakeWaitInfos);
                    if (mineTakeWaitInfos.size()<Integer.parseInt(UserManger.pageSize)){
                        mAdapter.loadMoreEnd();
                    }
                }else {
                    mAdapter.loadMoreEnd();
            ...
            case 2:
                ...
                //加载更多
                List<MineTakeWaitInfo> mineTakeWaitInfosTwo = AppJsonUtil.getArrayList(result,MineTakeWaitInfo.class);
                if (mineTakeWaitInfosTwo != null && mineTakeWaitInfosTwo.size() > 0) {
                    mAdapter.addDatas(mineTakeWaitInfosTwo);
